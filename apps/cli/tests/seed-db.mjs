...
// Usage: node seed-db.mjs <band_dir> <project_name> <project_path> <default_branch>
//
// Creates band.db with Drizzle migrations applied and a single project row.

import { createHash } from "node:crypto";
import { mkdirSync, readFileSync, readdirSync } from "node:fs";
import { join, resolve } from "node:path";

const [bandDir, projectName, projectPath, defaultBranch] =
